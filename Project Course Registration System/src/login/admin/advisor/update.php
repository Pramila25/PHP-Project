...
<body>
  ...
  <div class="container">
      ...
      <div class="d-flex mt-4 justify-content-center ">
        <button onclick="location.href='../advisor.php';" type="submit" class="btn btn-dark margin_custom_1">Update</button>

        <a href="update.php" id="cancel" name="cancel" class="btn btn-dark margin_custom_1">Cancel</a>
      </div>
    </div>
  </div>
...
$passedID = $_POST['staff_id'];

if(isset($_POST['staff_id'])) {

    $query = "SELECT * FROM advisor WHERE staff_id ='$passedID' ";
...
<div class="mx-auto text-center">
          ...
          <form action="update.php" method="post" class="p-4">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="last_name" value="$row[lastname]" >
              </div>
              
              <input type='hidden' name='update' value='yes'>
              <input type='hidden' name='staff_id' value='$passedID'>
...
_END;
    ...
    if (isset($_POST['update'])) {
        ...
        $query = "UPDATE `advisor` SET `first_name`='$first_name',`lastname`='$last_name' WHERE staff_id = '$staff_id'";
