...
$query = "SELECT * FROM advisor WHERE staff_id = '$passedUID' ";
...
while($row = $result->fetch_array(MYSQLI_ASSOC)){   //Creates a loop to loop through result
    ...
    echo "<tr><td>" . $row['staff_id'] . "</td><td>" . $row['first_name'] . "</td><td>". $row['lastname'] ."</td></tr>";
}
...
<form action="delete.php"  method="post" class="d-flex justify-content-center">
    ...
    <input type='hidden' name='staff_id' value='$passedUID'>
