  ...
  <div class=" px-3 mt-4 mx-auto text-center ">
    ...
    <div class="container">
      <div class=" px-3 mt-1 mx-auto text-center ">
        <div class="btn-group mr-2" role="group" aria-label="First group">
          <button onclick="location.href='faculty/add.php';" type="button" class="btn btn-dark">Add</button>
          <button onclick="location.href='faculty/view.php';" type="button" class="btn btn-dark">View</button>
          <button onclick="location.href='faculty/update.php';" type="button" class="btn btn-dark">Update</button>
        </div>
      </div>
    </div>
  </div>
