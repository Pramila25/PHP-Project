...
echo '<h1 class="display-4 mx-auto text-center mt-4">Faculty Information</h1>';
...
while($row = $result->fetch_array(MYSQLI_ASSOC)){   //Creates a loop to loop through result
    ...
    echo "<form  method='POST' action='faculty_detail.php'>"."<tr><td>" . $row['faculty_id'] . "</td><td>"
        . $row['first_name'] . "</td><td>". $row['last_name'] . "<input type='hidden' name='faculty_id'
    value='$row[faculty_id]'>"."</td><td>"."<input type='submit' value='View Detail'>"."</td></tr>"."</form>";
