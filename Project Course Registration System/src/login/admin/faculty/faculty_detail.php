...
$passedUID = $_POST['faculty_id'];

$conn = getConnection();
if ($conn->connect_error) die($conn->connect_error);


$query = "SELECT * FROM faculty WHERE faculty_id = '$passedUID' ";
...
while($row = $result->fetch_array(MYSQLI_ASSOC)){   //Creates a loop to loop through result
    ...
    echo "<tr><td>" . $row['faculty_id'] . "</td><td>" . $row['first_name'] . "</td><td>". $row['last_name'] ."</td></tr>";
}
...
<form action="delete.php"  method="post" class="d-flex justify-content-center">
    ...
    <input type='hidden' name='faculty_id' value='$passedUID'>
