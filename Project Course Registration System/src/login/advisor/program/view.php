  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link margin_custom_1" href="../../advisor.php">Admin</a>
        </li>
        <li class="nav-item">
...
while($row = $result->fetch_array(MYSQLI_ASSOC)){   //Creates a loop to loop through result
    ...
    echo "<form  method='POST' action='program_detail.php'>"."<tr><td>" . $row['program_id'] . "</td><td>"
        . $row['type'] . "</td><td>". $row['program_name'] . "<input type='hidden' name='program_id'
    value='$row[program_id]'>"."</td><td>"."<input type='submit' value='View Detail'>"."</td></tr>"."</form>";
